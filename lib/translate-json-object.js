...
function TranslateJSONObject() {
	...
	function init(options) {
		...
		if (!setting.googleApiKey && !setting.yandexApiKey && !setting.deeplApiKey) {
		...
		} else if (setting.deeplApiKey) {
			serviceType = constant.DEEPL_NAME;
			translateSrv = require('./service/deepl.js');
		} else {
